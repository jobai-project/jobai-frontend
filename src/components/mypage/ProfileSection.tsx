    ...
    <div className="space-y-6">
      ...
      <div className="border border-[#EBECFF]/90 rounded-2xl p-6 bg-white shadow-[0_4px_12px_rgba(124,119,255,0.08)]">
        ...
        <button
          ...
          className="flex items-center justify-center gap-2 w-full mt-4 py-2 border border-dashed border-app-border rounded text-sm text-gray-300 hover:bg-app-bg transition-colors disabled:opacity-50"
        >
